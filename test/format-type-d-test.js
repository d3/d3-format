...
tape("format(\",d\") can group thousands", function(test) {
  ...
  test.equal(f(1.3e27), "1,300,000,000,000,000,044,761,612,288");
  test.equal(f(1.3e107), "130,000,000,000,000,005,723,571,947,544,438,292,554,521,954,144,678,769,275,685,764,875,122,985,731,145,995,914,860,441,978,030,839,927,144,448");
  test.end();
});
